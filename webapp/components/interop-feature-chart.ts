...
@customElement('interop-feature-chart')
export class InteropFeatureChart extends LitElement {
  ...
  getChartOptions(
    ...
    const graphColors = this.getYearProp('browserInfo').map(
      (browserInfo: any) => browserInfo.graphColor
    );
    // Add Interop color.
